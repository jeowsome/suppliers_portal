    ...
    <div v-if="!invoice.loading && invoice.doc">
        <div class="container mt-5 py-3 border">
            <div class="row mb-3 vr-aligned">
                <div class="col-6">
                    <h1 class="text-gray-900 font-bold text-[32px]">Supplier Invoice: {{ invoice.doc.name }} <Badge>
                            {{ invoice.doc.status }}
                        </Badge>
                    </h1>
                </div>
                    ...
                    <div class="d-flex">
                        <div class="ms-auto">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn btn-primary btn-dark"> <router-link
                                        to="/">Back</router-link>
                                </button>
                            </div>
                        </div>
                ...
                <div class="mb-1 row">
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" readonly class="form-control-plaintext" id="suppplier_id"
                    ...
                    <div class="col">
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-5">
                                <TextInput :type="'date'" size="lg" variant="outline" placeholder="Payment Date"
                                    id="service_date" :disabled="true" v-model="invoice.doc.service_date" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mb-1 row">
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" readonly class="form-control-plaintext" id="suppplier_name"
                    ...
                    <div class="col">
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-5">
                                <TextInput :type="'date'" size="lg" variant="outline" placeholder="Invoice Date"
                                    id="invoice_date" :disabled="true" v-model="invoice.doc.invoice_date" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mb-1 row">
                    ...
                    <div class="col">
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-5">
                                <TextInput :type="'date'" size="lg" variant="outline" placeholder="Due Date"
                                    id="due_date" :disabled="true" v-model="invoice.doc.due_date" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mb-1 row">
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" readonly class="form-control-plaintext" id="invoice_terms"
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" readonly class="form-control-plaintext" id="zip_code"
                        ...
                        <div class="accordion accordion-flush" id="address-accordion">
                            <div class="accordion-item">
                                ...
                                <div id="collapse-2" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row mb-1" v-if="invoice.doc.payment_reference_no">
                                            <label for="payment_reference_no" class="col-sm-3 col-form-label">Payment
                                                Reference</label>
                                            <div class="col-sm-5">
                                                <input type="text" readonly class="form-control-plaintext"
                                                    id="payment_reference_no" :value="invoice.doc.payment_reference_no">
                                            </div>
                                        </div>
                                        <div class="row mb-1" v-if="invoice.doc.payment_reference_date">
                                            <label for="payment_reference_date" class="col-sm-3 col-form-label">Payment
                                                Date</label>
                                            <div class="col-sm-5">
                                                <TextInput :type="'date'" size="lg" variant="outline"
                                                    placeholder="Payment Date" id="payment_reference_date"
                                                    :disabled="true" v-model="invoice.doc.payment_reference_date" />
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <label for="notes" class="col-sm-3 col-form-label">Notes</label>
                                            <div class="col-sm-5">
                                                <Textarea :variant="'subtle'" size="md" placeholder="Enter Notes Here"
                                                    :disabled="true" v-model="invoice.doc.notes" label="" id="notes" />
                                            </div>
                                        </div>
