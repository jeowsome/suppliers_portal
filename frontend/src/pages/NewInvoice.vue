        ...
        <div class="container mt-5 py-3 border">
            ...
            <div class='container border-bottom pb-3'>
                <div class="mb-2 row">
                    <div class="col">
                        <div class="row">
                            <label for="supplier_invoice_number" class="col-sm-3 col-form-label">Invoice
                                Number</label>
                            <div class="col-sm-5">
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <TextInput :type="'date'" size="lg" variant="outline" placeholder="Service Date"
                                    id="service_date" :disabled="false" v-model="invoiceData.service_date" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <TextInput :type="'date'" size="lg" variant="outline" placeholder="Invoice Date"
                                    id="invoice_date" :disabled="false" v-model="invoiceData.invoice_date" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-2 row">
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <select class="form-select form-select-mb" aria-label="Invoice Terms"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row mb-1">
                                            <label for="payment_reference_no" class="col-sm-3 col-form-label">Payment
                                                Reference</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="payment_reference_no"
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <TextInput :type="'date'" size="lg" variant="outline"
                                                    ...
                                                    :disabled="false" v-model="invoiceData.payment_reference_date" />
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <Textarea :variant="'subtle'" size="md" placeholder="Enter Notes Here"
                                                    :disabled="false" v-model="invoiceData.notes" label="Notes"
                                                    id="notes" />
                                            </div>
                                        </div>
            ...
            <div class="container">
                ...
                <table class="table" v-if="invoiceItems.length !== 0">
                    ...
                    <tbody class="table-group-divider">
                        <tr v-for="(item, index) in invoiceItems" :key="index">
                            ...
                            <td>
                                <select class="form-select form-select-mb" aria-label="Service Types"
                            ...
                            <td>
                                <button type="button" class="btn btn-dark btn-sm"><i @click="deleteRow(index)"
                ...
                <div class="d-flex">
                    <div :class="invoiceItems.length === 0 ? 'ms-auto pt-3' : 'ms-auto'">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-dark btn-sm" @click="addRow"><i
...
const portalInvoice = createListResource({
    doctype: 'Supplier Portal Invoices', insert: {
        onSuccess() {
